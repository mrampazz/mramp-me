...
export const Content = () => (
  <div className={styles["content-container"]}>
    ...
    <div className={styles["text-container"]}>
      <p>
        I’m an italian CS student @ UNIPD, during my time at university I started getting <em>passionate</em> about{" "}
        <em>web development</em> both frontend and backend.
      </p>
    </div>
    <div className={styles["button-container"]}>
      <DarkButton href='/projects'>view projects</DarkButton>
